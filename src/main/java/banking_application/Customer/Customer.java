...
public class Customer {
    ...
    protected String account_funds = "0";
    protected String other_data = "....";
    protected String[] customer_tab;

    protected void add_new_customer(String id, String full_name) {
    ...
    protected Customer(String id, String full_name, String account_number, String account_funds, String other_data) {
        this.id = id;
        this.full_name = full_name;
